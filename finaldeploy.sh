...
# PBS Server for Cloud POC
PBSSERVER=nfscvxetc13vm
...
configure_cust()
{
	ln -s /share/data/chap /chap
	ln -s /share/data/util /util
	ln -s /share/data/data /data
	ln -s /share/data/vend /vend
}

instll_pbs()
{
	rpm -ivh /data/packages/pbs-mom-13.0.1.152391-0.x86_64.rpm
	rpm -ivh /data/packages/pbs-cmds-13.0.1.152391-0.x86_64.rpm
}


configure_pbs()
{
	sed -e 's/pbsserver/$PBSSERVER/g' /etc/pbs.conf
}
